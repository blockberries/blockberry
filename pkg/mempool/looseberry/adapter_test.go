...
func newMockNetwork(validatorID uint16) *mockNetwork {
	return &mockNetwork{
		...
		batchResponseMessages: make(chan *lbnetwork.BatchResponseMessage, 100),
...
func (m *mockNetwork) SendBatchResponse(validator uint16, resp *lbnetwork.BatchResponseMessage) error {
	return nil
}
...
func (m *mockNetwork) BatchResponseMessages() <-chan *lbnetwork.BatchResponseMessage {
	return m.batchResponseMessages
}
